...
class Loan {
  constructor(borrower, amount, interestRate, termInDays, collateral) {
    this.borrower = borrower;
    this.amount = amount;
    this.interestRate = interestRate;
    this.termInDays = termInDays;
    this.collateral = collateral;
    this.startTimestamp = blockTimestamp();
    this.lastInterestCalculation = this.startTimestamp;
  }
}
let LendingContract = (_dec = NearBindgen({
  requireInit: true
  ...
  payableFunction: true
}), _dec6 = call({}), _dec7 = call({}), _dec8 = call({}), _dec9 = call({}), _dec10 = view(), _dec11 = view(), _dec12 = view(), _dec13 = view(), _dec14 = view(), _dec(_class = (_class2 = class LendingContract {
  constructor() {
    this.owner = '';
    this.deposits = {};
    this.loans = {};
  ...
  borrow({
    ...
    const collateral = BigInt(attachedDeposit());
    ...
    log(`Borrowed ${borrowAmount} NEAR by ${accountId} for ${termInDays} days at ${interestRate}% interest`);
    return NearPromise.new(accountId).transfer(borrowAmount);
  }
  repay() {
    const accountId = predecessorAccountId();
    const repaymentAmount = BigInt(attachedDeposit());
    ...
    log(`Repaid ${dueAmount} NEAR by ${accountId}`);
  }
  withdraw({
    amount
  }) {
    ...
    log(`Withdrawn ${withdrawAmount} NEAR by ${accountId}`);
    return NearPromise.new(accountId).transfer(withdrawAmount);
  }
  liquidate({
    borrower
  }) {
    assert(predecessorAccountId() === this.owner, "Only the contract owner can liquidate loans");
    ...
    log(`Liquidated loan for ${borrower}. Liquidation amount: ${liquidationAmount}, Fee: ${liquidationFeeAmount}`);
  }
  claimInsuranceFund() {
    assert(predecessorAccountId() === this.owner, "Only the contract owner can claim the insurance fund");
    const amount = this.insuranceFund;
    this.insuranceFund = BigInt(0);
    log(`Claimed insurance fund: ${amount} NEAR`);
  ...
  updateInterestRates({
    ...
    assert(predecessorAccountId() === this.owner, "Only the contract owner can update interest rates");
    this.baseInterestRate = baseInterestRate;
    this.minCollateralRatio = minCollateralRatio;
    this.liquidationFee = liquidationFee;
    log(`Updated interest rates: Base=${baseInterestRate}, MinCollateral=${minCollateralRatio}, LiquidationFee=${liquidationFee}`);
  }
  getDepositBalance({
    accountId
  }) {
  ...
  calculateInterestRate(amount, termInDays) {
...
}, _applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "deposit", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "deposit"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "borrow", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "borrow"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "repay", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "repay"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "withdraw", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "withdraw"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "liquidate", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "liquidate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "claimInsuranceFund", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "claimInsuranceFund"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "updateInterestRates", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "updateInterestRates"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getDepositBalance", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "getDepositBalance"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getLoanDetails", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "getLoanDetails"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getTotalDeposits", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "getTotalDeposits"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getTotalLoans", [_dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "getTotalLoans"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getInsuranceFundBalance", [_dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "getInsuranceFundBalance"), _class2.prototype), _class2)) || _class);
function getInsuranceFundBalance() {
  const _state = LendingContract._getState();
  if (!_state && LendingContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = LendingContract._create();
  if (_state) {
    LendingContract._reconstruct(_contract, _state);
  }
  const _args = LendingContract._getArgs();
  const _result = _contract.getInsuranceFundBalance(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function getTotalLoans() {
  ...
  const _args = LendingContract._getArgs();
  const _result = _contract.getTotalLoans(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function getTotalDeposits() {
  ...
  const _args = LendingContract._getArgs();
  const _result = _contract.getTotalDeposits(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function getLoanDetails() {
  ...
  const _args = LendingContract._getArgs();
  const _result = _contract.getLoanDetails(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function getDepositBalance() {
  ...
  const _args = LendingContract._getArgs();
  const _result = _contract.getDepositBalance(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function updateInterestRates() {
  ...
  const _args = LendingContract._getArgs();
  const _result = _contract.updateInterestRates(_args);
  LendingContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function claimInsuranceFund() {
  const _state = LendingContract._getState();
  if (!_state && LendingContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = LendingContract._getArgs();
  const _result = _contract.claimInsuranceFund(_args);
  LendingContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function liquidate() {
  ...
  const _args = LendingContract._getArgs();
  const _result = _contract.liquidate(_args);
  LendingContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function withdraw() {
...
function repay() {
  ...
  const _args = LendingContract._getArgs();
  const _result = _contract.repay(_args);
  LendingContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function borrow() {
  ...
  const _args = LendingContract._getArgs();
  const _result = _contract.borrow(_args);
  LendingContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LendingContract._serialize(_result, true));
}
function deposit() {
...
export { borrow, claimInsuranceFund, deposit, getDepositBalance, getInsuranceFundBalance, getLoanDetails, getTotalDeposits, getTotalLoans, init, liquidate, repay, updateInterestRates, withdraw };
//# sourceMappingURL=lending_contract.js.map
